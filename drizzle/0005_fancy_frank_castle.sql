CREATE TYPE "public"."trip_status" AS ENUM('draft', 'active', 'completed', 'archived');--> statement-breakpoint
...
ALTER TABLE "trips" ADD CONSTRAINT "trips_cover_activity_id_activities_id_fk" FOREIGN KEY ("cover_activity_id") REFERENCES "public"."activities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "trips_one_active_per_user" ON "trips" USING btree ("user_id") WHERE "trips"."status" = 'active';--> statement-breakpoint
