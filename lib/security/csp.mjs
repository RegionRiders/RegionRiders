import { DEFAULT_REGION_TILE_SOURCE } from '../regions/defaultRegionTileSource.mjs';

function getRegionTileSourceOrigin() {
  const tileUrl = (process.env.NEXT_PUBLIC_REGION_TILE_URL || DEFAULT_REGION_TILE_SOURCE)
    .trim()
    .replace(/\/$/, '');
