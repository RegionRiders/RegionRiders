import { REGION_VISIT_HEARMAP_COLOR_THRESHOLDS } from '@/components/ActivityMap/config/mapConfig';
...
export function getRegionColorsHeatmap(
  ...
  thresholds: ColorThreshold[] = REGION_VISIT_HEARMAP_COLOR_THRESHOLDS
) {
